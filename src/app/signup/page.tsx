    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-secondary-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <div className="text-center">
          ...
          <p className="text-surface-600">Start creating amazing content with AI</p>
        </div>
        ...
        <div className="card p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor="terms" className="ml-2 block text-sm text-surface-700">
                I agree to the{' '}
          ...
          <div className="mt-6 bg-primary-50 rounded-lg p-4">
            <div className="flex items-center text-primary-800">
              ...
              <span className="font-medium">Free 100 tokens included!</span>
            </div>
